<template>
    <div ref="container" class="relative inline-block overflow-hidden" v-if="!isMobile" @mousemove="handleMouseMove" @mouseleave="hideMagnifier">
        ...
        <img loading="lazy" v-lazy="imageSrc" class="block w-full h-auto grayscale transition-all duration-100" alt="Logo" width="300" height="150" />
        ...
        <div class="absolute inset-0 pointer-events-none mix-blend-normal" v-show="show" :style="{
            ...
            <img loading="lazy" v-lazy="imageSrc" class="w-full h-auto" :style="{
    ...
    <div v-else>
        ...
        <img loading="lazy" v-lazy="imageSrc" class="block w-full h-auto" alt="Logo" width="300" height="150" />
    </div>
</template>
