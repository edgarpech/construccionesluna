        ...
        <div class="relative z-10 pb-20">
            <section class="min-h-screen flex flex-col justify-center px-10 md:px-32 lg:px-48 xl:px-60 pt-20 mt-10">
                ...
                <p class="text-left text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extralight text-white mb-12 tracking-wide">
                    ALBERCA HACIENDA DE <br> LAS PALMAS
                </p>
                ...
                <div class="w-full max-w-4xl text-left grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="flex flex-col space-y-2">
                        ...
                        <p class="text-xs md:text-sm text-white">
                            FEBRERO DEL 2020 - JULIO DEL 2020
                        </p>
                    </div>
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <p class="text-xs md:text-sm text-white">
                            HDA. DE SAN JUDAS 12, HACIENDA DE LAS PALMAS, 52763 JESÚS DEL MONTE, MÉX.
                        </p>
                    </div>
                </div>
                ...
                <div class="w-full max-w-4xl text-left mt-8">
                    <ul class="text-sm md:text-base text-white list-disc pl-5">
                        <li>AMPLIACIÓN Y REPARACIÓN DE ALBERCA DE 8 METROS DE LARGO Y 4 METROS DE ANCHO.</li>
                    </ul>
                </div>
                ...
                <div class="relative w-full h-96 md:h-[500px] mt-16 overflow-hidden group">
                    <div class="absolute inset-0 flex transition-transform duration-500 ease-out" :style="{ transform: `translateX(-${currentIndex * 100}%)` }">
                        <div v-for="(image, index) in galleryImages" :key="index" class="w-full h-full flex-shrink-0">
                            <img loading="lazy" v-lazy="image" class="w-full h-full object-contain" alt="Reparación de Alberca en México">
                        </div>
                    </div>
...
export default {
    data() {
        return {
            currentIndex: 0,
            galleryImages: [
                '/images/projects/Alberca/Alberca 1.webp',
                '/images/projects/Alberca/Alberca 2.webp',
                '/images/projects/Alberca/Alberca 3.webp',
                '/images/projects/Alberca/Alberca 4.webp',
                '/images/projects/Alberca/Alberca 5.webp',
                '/images/projects/Alberca/Alberca 6.webp',
                '/images/projects/Alberca/Alberca 7.webp',
                '/images/projects/Alberca/Alberca 8.webp'
            ]
        }
    },
    methods: {
