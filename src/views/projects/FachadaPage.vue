...
export default {
    data() {
        return {
            currentIndex: 0,
            galleryImages: [
                '/images/projects/Fachada/Edificio 1.jpeg',
                '/images/projects/Fachada/Edificio 2.jpeg',
                '/images/projects/Fachada/Edificio 3.jpeg',
                '/images/projects/Fachada/Edificio 4.jpeg',
            ]
        }
    },
    methods: {
