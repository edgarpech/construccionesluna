            ...
            <section class="min-h-screen flex flex-col justify-center px-10 md:px-32 lg:px-48 xl:px-60 pt-20 mt-10">
                ...
                <div class="relative w-full h-96 md:h-[500px] mt-16 overflow-hidden group">
                    <div class="absolute inset-0 flex transition-transform duration-500 ease-out" :style="{ transform: `translateX(-${currentIndex * 100}%)` }">
                        <div v-for="(image, index) in galleryImages" :key="index" class="w-full h-full flex-shrink-0">
                            <img loading="lazy" v-lazy="image" class="w-full h-full object-contain" alt="Muebles de Closet y Cocina en Bosque de las Lomas, Ciudad de México">
                        </div>
                    </div>
                ...
                <div class="flex overflow-x-auto py-4 space-x-3 mt-4 px-4 custom-scrollbar">
                    <div v-for="(image, index) in galleryImages" :key="index" @click="goTo(index)" class="flex-shrink-0 w-24 h-24 cursor-pointer border-2 transition-all relative overflow-hidden rounded-lg"
                        ...
                        <img loading="lazy" v-lazy="image" class="w-full h-full object-cover transition-transform duration-300 hover:scale-110" alt="Miniatura de Muebles de Closet y Cocina en Bosque de las Lomas, Ciudad de México">
...
export default {
    data() {
        return {
            currentIndex: 0,
            galleryImages: [
                '/images/projects/Muebles/Muebles 1.webp',
                '/images/projects/Muebles/Muebles 2.webp',
                '/images/projects/Muebles/Muebles 3.webp',
                '/images/projects/Muebles/Muebles 4.webp',
                '/images/projects/Muebles/Muebles 5.webp',
                '/images/projects/Muebles/Muebles 6.webp',
                '/images/projects/Muebles/Muebles 7.webp',
            ]
        }
    },
    methods: {
