            ...
            <section class="min-h-screen flex flex-col justify-center px-10 md:px-32 lg:px-48 xl:px-60 pt-20 mt-10">
                ...
                <div class="w-full max-w-4xl text-left grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="flex flex-col space-y-2">
                        ...
                        <p class="text-xs md:text-sm text-white">
                            CALLE 25A X 28 Y 30, COL. SANTA CLARA, DZIDZANTÚN, YUCATÁN, MÉX.
                        </p>
                    </div>
                </div>
                ...
                <div class="w-full max-w-4xl text-left mt-8">
                    <ul class="text-sm md:text-base text-white list-disc pl-5">
                        <li>
                            CONSTRUCCIÓN DE RESIDENCIA PARTICULAR DE DOS NIVELES, INCLUYENDO ÁREAS SOCIALES, ÁREAS PRIVADAS, ÁREA DE SERVICIO Y ALBERCA.
                        </li>
                    </ul>
                </div>
                ...
                <div class="relative w-full h-96 md:h-[500px] mt-16 overflow-hidden group">
                    <div class="absolute inset-0 flex transition-transform duration-500 ease-out" :style="{ transform: `translateX(-${currentIndex * 100}%)` }">
                        <div v-for="(image, index) in galleryImages" :key="index" class="w-full h-full flex-shrink-0">
                            <img loading="lazy" v-lazy="image" class="w-full h-full object-contain" alt="Residencia Particular en México">
                        </div>
                    </div>
                ...
                <div class="flex overflow-x-auto py-4 space-x-3 mt-4 px-4 custom-scrollbar">
                    <div v-for="(image, index) in galleryImages" :key="index" @click="goTo(index)" class="flex-shrink-0 w-24 h-24 cursor-pointer border-2 transition-all relative overflow-hidden rounded-lg"
                        ...
                        <img loading="lazy" v-lazy="image" class="w-full h-full object-cover transition-transform duration-300 hover:scale-110" alt="Miniatura de Residencia Particular en México">
...
export default {
    data() {
        return {
            currentIndex: 0,
            galleryImages: [
                '/images/projects/Residencia/Residencia 1.webp',
                '/images/projects/Residencia/Residencia 2.webp',
                '/images/projects/Residencia/Residencia 3.webp',
                '/images/projects/Residencia/Residencia 4.webp',
                '/images/projects/Residencia/Residencia 5.webp',
                '/images/projects/Residencia/Residencia 6.webp',
                '/images/projects/Residencia/Residencia 7.webp',
                '/images/projects/Residencia/Residencia 8.webp',
                '/images/projects/Residencia/Residencia 9.webp',
                '/images/projects/Residencia/Residencia 10.webp',
                '/images/projects/Residencia/Residencia 11.webp',
                '/images/projects/Residencia/Residencia 12.webp',
                '/images/projects/Residencia/Residencia 13.webp',
                '/images/projects/Residencia/Residencia 14.webp',
                '/images/projects/Residencia/Residencia 15.webp',
            ]
        }
    },
    methods: {
